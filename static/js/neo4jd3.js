...
var neo4jd3 = _dereq_('/static/js/neo4jd3');

module.exports = neo4jd3;

},{"/static/js/neo4jd3":2}],2:[function(_dereq_,module,exports){
/* global d3, document */
...
//Create d3 data
    function loadNeo4jDataFromUrl(neo4jDataUrl) {
        ...
        d3.json("/graph2", function(error, graph) {
                if (error) {
                throw error;
                }
                if(graph){
                ...
                //TODO: Format the php graph data like how neo4jdata is expected below in neo4jDataToD3Data
            //console.log( 'Debug Objects:'+graph );
        });
                    ...
                    data.graph.nodes.forEach(function(node) {
                        if (!contains(graph.nodes, node.id)) {
                            graph.nodes.push(node);
                                             ...
                                             var joinedValues = joinedValues+'|'+result;
